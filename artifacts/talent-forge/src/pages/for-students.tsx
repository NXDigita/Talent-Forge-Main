  ...
  return (
    <div className="min-h-screen bg-[#0F172A] pt-24 pb-20">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        {/* Journey Timeline */}
        <div className="mb-24">
          <h2 className="text-3xl font-bold text-white text-center mb-12">The Forge Journey</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              {[
                ...
                <div key={i} className="relative flex flex-col items-center text-center">
                  <div className="w-16 h-16 rounded-full bg-slate-800 border-4 border-[#0F172A] flex items-center justify-center text-sky-400 z-10 mb-4 shadow-[0_0_15px_rgba(56,189,248,0.2)]">
                    {step.icon}
                  </div>
        ...
        <div className="glass-card p-8 md:p-12 mb-24 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-400 mb-8">Estimate your potential monthly earnings working on freelance projects through Talent Forge.</p>
              
              <div className="space-y-6">
                <div>
                  <label className="text-sm font-medium text-slate-300 mb-2 flex justify-between">
                    <span>Hours per week</span>
                    <span className="text-sky-400">{hours[0]} hrs</span>
                  </label>
                  <Slider 
                    value={hours} 
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-slate-300 mb-2 block">Current Tier</label>
            ...
            <div className="bg-slate-900/80 rounded-2xl p-8 border border-slate-800 text-center">
              <p className="text-slate-400 mb-2 uppercase tracking-wider text-sm font-semibold">Estimated Monthly Earnings</p>
              ...
              <p className="text-sm text-slate-500 mb-8">Based on average project rates for {tier}s in this domain.</p>
