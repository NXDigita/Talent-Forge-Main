...
export default function About() {
  return (
    <div className="min-h-screen bg-[#0F172A] pt-24 pb-20">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4 mt-8">
              <div className="glass-card p-6 text-center">
                <Shield className="w-8 h-8 text-sky-400 mx-auto mb-3" />
                <h4 className="text-white font-bold mb-2">Verified</h4>
                <p className="text-xs text-slate-400">Blockchain-backed credentials.</p>
              </div>
              <div className="glass-card p-6 text-center">
                <Target className="w-8 h-8 text-amber-500 mx-auto mb-3" />
                <h4 className="text-white font-bold mb-2">Meritocratic</h4>
                <p className="text-xs text-slate-400">Skills over degrees.</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="glass-card p-6 text-center">
                <Zap className="w-8 h-8 text-blue-500 mx-auto mb-3" />
                <h4 className="text-white font-bold mb-2">Efficient</h4>
                <p className="text-xs text-slate-400">Instant AI matching.</p>
              </div>
              <div className="glass-card p-6 text-center">
                <Globe className="w-8 h-8 text-green-500 mx-auto mb-3" />
                <h4 className="text-white font-bold mb-2">Accessible</h4>
                <p className="text-xs text-slate-400">Open to all India.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Stats Strip */}
      <section className="border-y border-slate-800 bg-slate-900/50 py-16 mb-32">
        <div className="container mx-auto max-w-5xl px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-slate-500 uppercase tracking-wider">Startups</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-white mb-2">2M+</div>
              <div className="text-sm font-medium text-slate-500 uppercase tracking-wider">Assessments</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-white mb-2">₹50Cr</div>
              <div className="text-sm font-medium text-slate-500 uppercase tracking-wider">Paid to Talent</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Team Section */}
      <section className="container mx-auto max-w-6xl px-4 mb-32">
        <h2 className="text-3xl font-bold text-white text-center mb-16">The Builders</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={i} className="glass-card p-6 text-center group">
              <div className="w-24 h-24 mx-auto rounded-full bg-slate-800 border-2 border-slate-700 mb-6 group-hover:border-sky-400 transition-colors flex items-center justify-center text-2xl font-bold text-slate-500">
                {member.name.charAt(0)}
              </div>
              <h3 className="text-lg font-bold text-white mb-1">{member.name}</h3>
              <p className="text-sky-400 text-sm font-medium mb-3">{member.role}</p>
              <p className="text-slate-500 text-xs uppercase tracking-wider">{member.exp}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="container mx-auto max-w-4xl px-4 text-center">
        <p className="text-slate-500 text-sm font-medium uppercase tracking-wider mb-8">Backed by top tier investors</p>
        <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          <div className="text-2xl font-bold text-white font-serif">Sequoia</div>
          <div className="text-2xl font-bold text-white tracking-widest">LIGHTSPEED</div>
          <div className="text-2xl font-bold text-white italic">Elevation</div>
          <div className="text-2xl font-bold text-white">Accel</div>
        </div>
      </section>
