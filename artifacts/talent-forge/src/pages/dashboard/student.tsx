    ...
    <div className="min-h-screen bg-[#0F172A] pt-20 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-64 bg-slate-900 border-r border-slate-800 p-6 flex flex-col hidden md:flex h-[calc(100vh-80px)] sticky top-20">
        <div className="flex items-center gap-4 mb-8 p-4 bg-slate-800/50 rounded-xl border border-slate-700">
          ...
          <div>
            <h3 className="font-bold text-white leading-tight">John Doe</h3>
            <span className="text-xs font-medium text-amber-500 uppercase tracking-wider">Practitioner</span>
          </div>
        </div>

        <nav className="space-y-2 flex-1">
          <Link href="/dashboard/student" className="flex items-center gap-3 px-4 py-3 text-white bg-blue-600/10 border border-blue-500/20 rounded-lg transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="glass-card p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-slate-400 font-medium">TFES Score</h3>
              <div className="w-8 h-8 rounded-lg bg-green-500/10 flex items-center justify-center">
                <TrendingUp className="w-4 h-4 text-green-500" />
              </div>
            </div>
            <div className="text-3xl font-bold text-white mb-1">84<span className="text-lg text-slate-500">/100</span></div>
            <p className="text-xs text-green-400">+5 from last month</p>
          </div>
          
          <div className="glass-card p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-slate-400 font-medium">Completed Projects</h3>
              <div className="w-8 h-8 rounded-lg bg-blue-500/10 flex items-center justify-center">
                <CheckCircle2 className="w-4 h-4 text-blue-500" />
              </div>
            </div>
            <div className="text-3xl font-bold text-white mb-1">3</div>
            <p className="text-xs text-slate-400">2 active right now</p>
          </div>
          ...
          <div className="glass-card p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-slate-400 font-medium">Global Rank</h3>
              <div className="w-8 h-8 rounded-lg bg-purple-500/10 flex items-center justify-center">
                <Award className="w-4 h-4 text-purple-500" />
              </div>
            </div>
            <div className="text-3xl font-bold text-white mb-1">Top 15%</div>
            <p className="text-xs text-slate-400">In Computer Science</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="glass-card p-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <Button variant="ghost" className="text-sky-400 hover:text-sky-300 hover:bg-sky-400/10">View All</Button>
              </div>
                ...
                <div className="p-4 bg-slate-900/50 rounded-xl border border-slate-800">
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg bg-blue-900/50 flex items-center justify-center border border-blue-800">
                        <BookOpen className="w-5 h-5 text-blue-400" />
                      </div>
                      <div>
                        <h4 className="text-white font-medium">Advanced React Assessment</h4>
                        <p className="text-xs text-slate-400">Required for "React Expert" badge</p>
                      </div>
                    </div>
                ...
                <div className="p-4 bg-slate-900/50 rounded-xl border border-slate-800">
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-white font-medium">Complete E-commerce Dashboard</h4>
                        <p className="text-xs text-slate-400">Client: RetailFlow Inc.</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-4 mt-4">
                    ...
                    <span className="text-xs text-slate-400 font-medium">85%</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-900/50 rounded-xl border border-slate-800 gap-4 hover:border-slate-600 transition-colors cursor-pointer">
                    <div>
                      <h4 className="text-white font-medium mb-1">{job.title}</h4>
                      <p className="text-sm text-slate-400 font-medium text-amber-500">{job.budget}</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="flex flex-col items-end">
                        <span className="text-xs text-slate-500 mb-1">Match Score</span>
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-1">Practitioner Tier</h3>
              <p className="text-sm text-slate-400 mb-6">450 XP to Expert</p>
              
              <div className="w-full h-3 bg-slate-800 rounded-full mb-3 overflow-hidden">
            ...
            {/* Recent Badges */}
            <div className="glass-card p-6">
              <h3 className="text-lg font-bold text-white mb-4">Recent Credentials</h3>
              <div className="flex items-center gap-4 p-4 bg-slate-900/50 border border-slate-800 rounded-xl mb-3">
                <div className="w-12 h-12 rounded-full bg-blue-500/20 flex items-center justify-center border border-blue-500/50">
                  <Code2 className="w-6 h-6 text-blue-400" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-white">React Foundations</h4>
                  <p className="text-xs text-slate-400">Verified • 2 days ago</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-slate-900/50 border border-slate-800 rounded-xl">
                ...
                <div>
                  <h4 className="text-sm font-bold text-white">SQL Optimization</h4>
                  <p className="text-xs text-slate-400">Verified • 1 week ago</p>
                </div>
              </div>
              <Button variant="link" className="w-full mt-4 text-sky-400">View Blockchain Records</Button>
            </div>
